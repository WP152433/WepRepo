...
<div class="container">
  ...
  <form class="form-signin" action="${ contextPath }/login.do" method="post">
    ...
    <input type="email" name="id" id="inputEmail" class="form-control" placeholder="Email address" autofocus>
    
    <label for="inputPassword" class="sr-only">Passwo"WebContent/jsp/login.jsp"rd</label>
